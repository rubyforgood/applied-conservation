...
class User < ApplicationRecord
  ...
  has_many :health_assessments_as_updater, inverse_of: :created_by, class_name: 'HealthAssessment',
                                           foreign_key: :updated_by_id, dependent: :restrict_with_error
  has_many :health_attributes_as_creator, inverse_of: :created_by, class_name: 'HealthAttribute',
                                          foreign_key: :created_by_id, dependent: :restrict_with_error
  has_many :health_attributes_as_updater, inverse_of: :created_by, class_name: 'HealthAttribute',
                                          foreign_key: :updated_by_id, dependent: :restrict_with_error
  has_many :health_rating_types_as_creator, inverse_of: :created_by, class_name: 'HealthRatingType',
                                            foreign_key: :created_by_id, dependent: :restrict_with_error
  has_many :health_rating_types_as_updater, inverse_of: :created_by, class_name: 'HealthRatingType',
                                            foreign_key: :updated_by_id, dependent: :restrict_with_error
  has_many :health_ratings_as_creator, inverse_of: :created_by, class_name: 'HealthRating',
                                       foreign_key: :created_by_id, dependent: :restrict_with_error
  has_many :health_ratings_as_updater, inverse_of: :created_by, class_name: 'HealthRating',
                                       foreign_key: :updated_by_id, dependent: :restrict_with_error
end
